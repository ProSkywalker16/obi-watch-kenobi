            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-10">
              ...
              <div className=" flex justify-center overflow-hidden">
                <img
                  ...
                  className="w-full h-80 object-contain rounded-lg shadow-xl transition-opacity duration-1000"
                />
              </div>


              <div className="text-left ">
                <h3 className="text-2xl font-semibold mb-3 text-cyan-400">Built for Every Operation</h3>
